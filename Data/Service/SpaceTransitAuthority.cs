    ...
    public class SpaceTransitAuthority : ISpaceTransitAuthority
    {
        ...
        public SpaceTransitAuthority()
        {
            ...
            Wings = new List<Wing>
            {
                new Wing
                {
                    Id = 1, Name = "Blade", Agility = 0, Speed = 15, Energy = 0, NumberOfHardpoints = 2, Weight = 275
                },
                new Wing
                {
                    Id = 2, Name = "Horizon", Agility = 7, Speed = 8, Energy = 0, NumberOfHardpoints = 1, Weight = 150
                },
                new Wing
                {
                    Id = 3, Name = "D-Fence", Agility = 0, Speed = 0, Energy = 0, NumberOfHardpoints = 3, Weight = 300
                },
                new Wing
                {
                    Id = 4, Name = "O-Fence", Agility = 0, Speed = 0, Energy = 15, NumberOfHardpoints = 2, Weight = 250
                },
                new Wing
                {
                    Id = 5, Name = "Raceing", Agility = 15, Speed = 15, Energy = 0, NumberOfHardpoints = 1, Weight = 175
                }
            };
